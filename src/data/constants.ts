export const towns = [
  { name: 'Baton Rouge', slug: 'baton-rouge', businesses: 0 },
  { name: 'Baker', slug: 'baker', businesses: 0 },
  { name: 'Zachary', slug: 'zachary', businesses: 0 },
  { name: 'Central', slug: 'central', businesses: 0 },
  { name: 'Greenwell Springs', slug: 'greenwell-springs', businesses: 0 },
  { name: 'Pride', slug: 'pride', businesses: 0 },
];
