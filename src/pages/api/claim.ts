...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on EastBatonRougeLA.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'EastBatonRougeLA.com <noreply@contact.eastbatonrougela.com>',
          to: ['hello@eastbatonrougela.com'],
          subject: `New Claim Request: ${business.title} — EastBatonRougeLA.com`,
          reply_to: email,
          text: emailBody,
        }),
